...
import { selectInvitationEscrow } from 'redux/user';
          ...
          <View style={styles.Card}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 90 }}>
              <View style={styles.EscrowbchainSmallContainer}>
                ...
                <Text style={styles.smallText}>{Invitations?.sender_name}</Text>
              </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 90 }}>
              <View style={styles.EscrowbchainSmallContainer}>
                <Svg name="currancy" />
                <Text style={styles.smallText}>{Invitations?.escrow_value}</Text>
              </View>
              <View style={styles.EscrowbchainSmallContainer}>
                <Svg name="date" />
                <Text style={styles.smallText}>{TransferDate(Invitations.escrow_start_date)}</Text>
              </View>
            </View>
          </View>
          <View style={styles.Card}>
            ...
            <View style={styles.RowBetween}>
              <Text style={styles.salaryText}>{Invitations?.escrow_value}</Text>
              <Svg name="wallet" style={{ marginRight: 12 }} />
            </View>
          </View>

          <View style={styles.Card}>
            <Text style={styles.WalletBalanceText}>Description</Text>
            <Text style={styles.smallText2}>{Invitations?.escrow_description}</Text>
          </View>
        </View>
      </ScrollView>
    </View>
