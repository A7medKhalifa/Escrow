  ...
  return (
    ...
    >
      ...
      <View style={styles.container}>
        <Text style={styles.Title}>Pay for milestone 2</Text>

        <TouchableOpacity activeOpacity={.8} onPress={() => navigate('MilestonesType', { id: 1 })} style={styles.SupplierCard}>
        ...
        <Button
          style={styles.button}
          type="primary"
          label="Pay supplier & mark as completed"
        onPress={() => { 
          setShow(false)
          navigate('Milestones') 
        }}
