      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={styles.Card}>
            <Text style={[styles.smallText, { position: 'absolute', top: -h * .035, left: 12.5 }]}>Seller Info</Text>

            <Text style={[styles.WalletBalanceText, { fontWeight: 'bold' }]}>Buffay Bing</Text>
            <Text style={styles.smallText2}>App Developer at Bl.a</Text>
