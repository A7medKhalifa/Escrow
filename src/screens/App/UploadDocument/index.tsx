      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          <View style={styles.Circle}>
            <Svg name='file' height={42} width={42} bgColor={COLORS.sky} />
          </View>
          <Text style={styles.Text}>Upload confirmation documents</Text>
          ...
          <Text style={styles.Header}>Bill of Lading</Text>
          <TouchableOpacity activeOpacity={.8} style={styles.UploadButton}
            onPress={() => { }} >
            <Text style={styles.UploadText}>Upload</Text>
          </TouchableOpacity>
          ...
          <Button
            ...
            onPress={() => navigate('MilestonesType')}
          />
        </View>
