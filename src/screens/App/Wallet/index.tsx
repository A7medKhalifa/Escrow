    ...
    <View
      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={styles.Card}>
            <Text style={styles.WalletBalanceText}>Transactions History</Text>
            <FlatList
              data={[{}, {}]}
                ...
                <View style={styles.SupplierCard}>
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={styles.TextContainer2}>
                      <Text style={styles.Head1}>Cash Withdrawal</Text>
                      <Text style={styles.describe}>From: Emaar Egypt</Text>
                      <Text style={styles.describe}>WP: 222000p</Text>
                    </View>
                  </View>
                  <View >
