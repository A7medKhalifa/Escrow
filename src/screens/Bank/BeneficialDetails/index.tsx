      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={[styles.Card,{marginTop:40}]}>
            <Text style={[styles.smallText, { position: 'absolute',fontWeight:'700', top: -h * .035, left: 12.5 }]}>Seller Info</Text>

            <Text style={[styles.WalletBalanceText, { fontWeight: 'bold' }]}>O-Projects </Text>
            <Text style={styles.smallText2}>LLC</Text>
            <View style={styles.divider} />
            <Text style={styles.smallText}>Industry</Text>
            <Text style={styles.WalletBalanceText}>Development House</Text>
            ...
            <Text style={styles.smallText}>Buyer</Text>
...
export default BeneficialDetailsScreen;
