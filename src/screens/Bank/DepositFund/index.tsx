...
import { DepositFund_initial_values } from 'src/formik/initial_values';
import { DepositFundScheme } from 'src/formik/schema';
      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={styles.Card}>
            ...
            <Text style={styles.price}>$1500.00</Text>
            <View style={{ height: 1, backgroundColor: COLORS.alfaBlack, marginVertical: 15 }} />
            <Text style={styles.WalletBalanceText}>Wallet Balance</Text>
            <Text style={styles.price}>$250.00</Text>
          </View>
          <Formik
            initialValues={DepositFund_initial_values}
            validationSchema={DepositFundScheme}
            onSubmit={values => {
              console.log(values);
            }}>
            {props => (
