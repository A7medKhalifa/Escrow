          ...
          <View style={styles.Card}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 90 }}>
              <View style={styles.EscrowbchainSmallContainer}>
                ...
                <Text style={styles.smallText}>Buffay Bing</Text>
              </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 90 }}>
              ...
              <View style={styles.EscrowbchainSmallContainer}>
                <Svg name="date" />
                <Text style={styles.smallText}>12/3/2020</Text>
              </View>
            </View>
          ...
          <View style={styles.Card}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 15 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Image style={styles.S_Image} source={{ uri: uri }} />
                <Text style={styles.sellerName}>Sara Ross</Text>
              </View>
              <TouchableOpacity activeOpacity={.8} onPress={()=>{navigate('BeneficialDetails')}} style={{
                paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10, backgroundColor: COLORS.move
              }}>
