        ...
        <View style={styles.container}>
          <View style={styles.sec_container}>
            ...
            <LinearGradient
              ...
              <Text style={styles.Successfully}>Payment Details</Text>
            </LinearGradient>
            ...
            <View style={styles.SmallContainer}>
              <View style={styles.Row}>
                ...
                <View>
                  <Text style={styles.WalletBalanceText}>TIME</Text>
              ...
              <View style={[styles.Row, { marginTop: 30 }]}>
                <View style={{}}>
                  <Text style={styles.WalletBalanceText}>Escrow</Text>
                  <Text style={styles.smallHeaderText}>O-Projects</Text>
                </View>
              ...
              <View style={{ marginTop: 30, }}>
                ...
                <Text style={styles.SalaryText}>$520.00</Text>
              </View>
              ...
              <TouchableOpacity activeOpacity={.8} onPress={() => { }} style={[styles.SupplierCard]}>
                ...
                <View style={[styles.TextContainer, { height: 35, }]}>
                  <Text style={styles.smallHeaderText}>Mina Ezzat</Text>
                  <Text style={styles.smallText}>Escrow Name</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <Button
            svg='UploadCircle'
            style={{ marginTop: h * 0.05, width: '90%', alignSelf: 'center' }}
            type="primary"
