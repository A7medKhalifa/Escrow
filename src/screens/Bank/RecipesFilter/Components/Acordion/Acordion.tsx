...
const AnimatedAcordion = () => (
  <View style={styles.containerStyle}>
    <AccordionItem title={'Escrow Amount'} price={'$1500.00'} content={
      <>
        <View style={styles.Card}>
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={styles.TextContainer}>
              ...
              <Text style={styles.Head2}>$721.00</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.Card}>
          <View style={{ flexDirection: 'row' }}>
            <Svg name='milestone' />
            <View style={styles.TextContainer}>
              <Text style={styles.Head1}>Milestone 2</Text>
              <Text style={styles.Head2}>$361.00</Text>
            </View>
          </View>
        </View>
