...
import AnimatedAcordion from './Components/Acordion/Acordion';


const RecipesFilterScreen = () => {
    ...
    <View
      ...
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          {/* <View style={styles.Card}>
            <Text style={styles.WalletBalanceText}>Escrow Amount</Text>
          ...
          <FlatList
            data={[
              { name: 'Oprojects', dis: 'Work Package Details',navigate:'BeneficialDetails' },
              { name: 'Mina Ezzat Rawi Said', dis: 'Buyer Details',navigate:'OwnerDetails' }
            ]}
            nestedScrollEnabled
            contentContainerStyle={{ marginTop: 18, marginBottom: 50, alignItems: 'center', width: '95%', alignSelf: 'center' }}
            renderItem={({ item }) => (
              <TouchableOpacity activeOpacity={.8} onPress={() => navigate(item.navigate)} style={[styles.SupplierCard]}>
                ...
                <View style={[styles.TextContainer, { height: 35, }]}>
                  ...
                  <Text style={styles.smallText}>{item.dis}</Text>
                </View>
